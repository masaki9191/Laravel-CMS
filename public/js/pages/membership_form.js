...
//                        tableBody += '<tr><td>Prefecture name</td><td>' + jQuery('[name="ken"]').val() + '</td></tr>';
...
//            });
        ...
        toggleFields: function () {
            if (jQuery('[name="cms_kaiin_type"]').val() != 3) {
                jQuery('.cms_corporation_type').show();
            } else {
                jQuery('.cms_corporation_type').hide();
            }
            if (jQuery('[name="cms_kaiin_type"]').val() == 1) {
                jQuery('.group-sec').show();
            } else {
                jQuery('.group-sec').hide();
            }
            if (jQuery('[name="cms_kaiin_member_main"]').val() == 1) {
...
//                self.showForm();
//            });
            jQuery('body').on('change', '[name="cms_kaiin_type"],[name="cms_kaiin_member_main"]', function () {
