                ...
                <div class="row about-intro">
                    <div class="col-sm-12 pb-5 text">
                        <div class="p-3 heading" style="background:#ECEFF4">
                            <h4 class="headingfontsize special_padding">継続的研修</h4>
                        </div>
                    </div>
                    <div class="col-sm-12 pb-5 text">
                    ...
                    <div class="col-sm-4 pb-2 text" style="padding: 0px 12px;">
                        <div class="calculation" >
                            ...
                            <p class="text-center"><span>定員 </span> <span style='color:#1C689D'>00</span> <span>名</span> </p>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="margin-top:20%">
            ...
            <div class="modal-footer mb-5" style="justify-content: center;">
                ...
                <a  href="{{ route('frontend.workshop.create',['kensyu_id'=>$record->id]) }}" style="display:none" class='btn btn-below-2 modalbtnfooter yellowbtn confrm-enable'> トップページへ <span span class="float-right"><i class="fa fa-chevron-right"></i></span></a>
            </div>
        </div>
    </div>
</div>
