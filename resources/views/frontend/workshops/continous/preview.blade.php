<div class="container">
            ...
            <div class="col-sm-12">
                ...
                <div class="border_bottom">
                    <div class="row ">
                        ...
                        <div class="col-sm-7 pt-4">
                            <p class="address">東京都 文京区本郷3-39-17 KOGAビル4階</p>
                        </div>
                    </div></div>
            ...
            <div class="col-sm-12">
                ...
                <div class="border_bottom">
                    <div class="row ">
                        ...
                        <div class="col-sm-7 pt-4">
                            <p class="caddress">東京都 文京区本郷3-39-17 KOGAビル4階</p>
                        </div>
                    </div></div>
            ...
            <div class="col-sm-12">
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class="col-sm-7 pt-4">
                            <p class="mail">sakaguchi@jahid.gr.jp</p>
                        </div>
                    </div></div>
                <div class="border_bottom">
                    <div class="row ">
                ...
                <div class="border_bottom">
                    <div class="row ">
                        ...
                        <div class="col-sm-7 pt-4">
                            <p class="member">一般社団法人 日本医療機器販売業協会 会員</p>
                        </div>
                    </div></div>
    ...
    <div class="col-sm-12 justify-content-center text-center pt-5 pb-3">
        ...
        <button type="submit" class='btn btn-below-2 submit-form'>送信する <i class="fa fa-chevron-right float-right"></i></button>
    </div>
