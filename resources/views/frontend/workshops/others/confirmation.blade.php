            ...
            <div class="offset-md-1 col-md-10">
                <div class="row justify-content-center about-intro">
                    <div class="col-sm-12 pb-2 text">
                        <div class="p-3">
                            <p class="headingfont"><b>申し込み完了</b></p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 pb-5 text">
                        <p class="parafont">※ 請求書につきましては、申込内容を確認後「kenshu@jahid.gr.jp」より休日を除き5日以内に送付させていただきます。</p>
                        <p class="parafont">万が一届かない場合は、メールアドレスに誤りがあるかもしれませんので、必ず、下記までFAXにてご連絡ください。</p>
                    </div>
