    <div class="container">
            ...
            <div class="offset-md-1 col-md-10">
                <div class="row about-intro">
                    <div class="col-sm-12 pb-5 text">
                        <div>
                            <h4 class="headingfontsize special_padding">開催一覧</h4>
                        </div>
                    </div>
                    <div class="col-sm-12 pb-5 text">
            ...
            <div class="offset-md-1 col-md-10">
                ...
                <div class="col-sm-12">
                    <div class="border_bottom">
                        <div class="row">
                            <div class="col-sm-5 pt-4">
                                <p><b>受講者</b> <span class="warning_bg">必須</span></span></p>
                            </div>
                    ...
                    <div class="border_bottom">
                        <div class="row ">
                            <div class="col-sm-5 pt-4">
                                <p><b>ふりがな</b>  <span class="warning_bg">必須</span></span></p>
                            </div>
                            <div class="col-sm-7 pt-4">
                                <p>さかぐち こうだい</p>
                            </div>
            ...
            <div class="offset-md-1 col-md-10">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="border_bottom">
                        <div class="row ">
                            <div class="col-sm-5 pt-4">
                                <p><b>営業所名</b>  <span class="info_bg">任意</span></p>
                            </div>
                            <div class="col-sm-7 pt-4">
                                <p>本郷営業所</p>
                            </div>
        ...
        <div class="row pb-5">
            <div class="offset-md-1 col-md-10">
                <div class="col-sm-12 pb-3 text">
                    <div class="border_bottom-2">
                        <h4 class="headingfontsize pb-2">所在地</h4>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="border_bottom">
                        <div class="row">
                            ...
                            <div class="col-sm-7 pt-4">
                                <p>sakaguchi@jahid.gr.jp</p>
                            </div>
                        </div></div>
                    <div class="border_bottom">
                        <div class="row ">
                            <div class="col-sm-5 pt-4">
                                <p><b>営業所名</b>  <span class="warning_bg">必須</span></p>
                            </div>
                            <div class="col-sm-7 pt-4">
                                <p>03-5689-7530</p>
                            </div>
                    ...
                    <div class="border_bottom">
                        <div class="row ">
                            <div class="col-sm-5 pt-4">
                                <p><b>FAX番号</b>  <span class="info_bg">任意</span></p>
                            </div>
                            <div class="col-sm-7 pt-4">
                                <p>03-5689-7919</p>
                            </div>
        ...
        <div class="col-sm-12 justify-content-center text-center pt-5 pb-3">
            <button type="button" class='btn btn-below-2 show-form-btn' style='background:#707F89'><i class="fa fa-chevron-left float-left"></i> 書き直す </button>
            <a href='{{ route('frontend.workshop.confirmation') }}' class='btn btn-below-2 submit-form'>送信する <i class="fa fa-chevron-right float-right"></i></a>
        </div>
