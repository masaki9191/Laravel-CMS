        ...
        <div class="offset-md-1 col-md-10">
            <div class="row about-intro">
                <div class="col-sm-12 pb-5 text">
                    <div>
                        <h4 class="headingfontsize special_padding">受講お申し込み</h4>
                    </div>
                </div>
                <div class="col-sm-12 pb-5 text">
            ...
            <div class="col-sm-12 p-0">
                    ...
                    <div class="row">
                        ...
                        <div class='col-sm-4 pt-4'>
                            <div class="form-group">
                                <input type="text" class='form-control input-box' value="坂口">
                                <label>坂口</label>
                            </div>
                        </div>
                        <div class='col-sm-4 pt-4'>
                            <div class="form-group">
                                <input type="text" class='form-control input-box' value="広大">
                                <label>広大</label>
                            </div>
                        </div>
                    </div></div>
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class='col-sm-4 pt-4'>
                            <div class="form-group">
                                <input type="text" class='form-control input-box' value="さかぐち">
                                <label>さかぐち</label>
                            </div>
                        </div>
                        <div class='col-sm-4 pt-4'>
                            <div class="form-group">
                                <input type="text" class='form-control input-box' value="こうだい">
                                <label>こうだい</label>
                            </div>
                        </div>
                    </div></div>
            ...
            <div class="col-sm-12 p-0">
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class='col-sm-4 pt-4'>
                            <button type = "button" class='btn btn-custom'>郵便番号検索</button>
                        </div>
                    </div></div>
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class='col-sm-8 pt-4'>
                            <div class="form-group">
                                <select name='options' class='select-box'>
                                    <option>東京都</option>
                                </select>
            ...
            <div class="col-sm-12 p-0">
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class='col-sm-8 pt-4'>
                            <div class="form-group">
                                <input type="text" class='form-control input-box' value="日本医療機器販売業協会">
                ...
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class='col-sm-8 pt-4'>
                            <div class="form-group">
                                <input type="text" class='form-control input-box' value="本郷営業所">
            ...
            <div class="col-sm-12 p-0">
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class='col-sm-8 pt-4'>
                            <div class="form-group">
                                <input type="text" class='form-control input-box' value="sakaguchi@jahid.gr.jp">
                ...
                <div class="border_bottom">
                    <div class="row">
                        ...
                        <div class='col-sm-8 pt-4'>
                            <div class="form-group">
                                <input type="text" class='input-box-1' > - <input type="text" class='input-box-1'> - <input type="text" class='input-box-1'>
    ...
    <div class="row pb-5">
        <div class="offset-md-1 col-md-10">
            <div class="col-sm-12 text-center pb-5 text">
                <button type='button' class='btn btn-below-2 form-preview-btn'>内容確認 <i class="fa fa-chevron-right"></i></button>
            </div>
        </div>
    </div>
</div>
