...
<div class="content">
    <div class="block block-rounded">
        <div class="block-header">
            <h3 class="block-title">{{ __('Edit registration') }}</h3>
        </div>
        <div class="block-content block-content-full">
            ...
            <form method="POST" enctype="multipart/form-data" class="workshop-form" action="{{ route('workshopRegistration.update',$registration->id) }}">
                @csrf
                {{ method_field('PUT') }}
